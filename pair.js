...
┃ ⤷ 𝙳𝙴𝚅        ✧ ${config.OWNER_NAME}
╰━━━━━━━━━━━━━━━━━≽
┃ ⟬✦⟭ 𝚂𝙴𝙻𝙴𝙲𝚃 𝙰 𝙲𝙰𝚃𝙴𝙶𝙾𝚁𝚈 ⟬✦⟭
╰━━━━━━━━━━━━━━━━━≽
┃⤷ 𝚙𝚘𝚠𝚎𝚛𝚎𝚍 ✧ ${config.BOT_FOOTER}
╰━━━━━━━━━━━━━━━━━≽
`;
      ...
      buttons: [
        {
          ...
          buttonText: { displayText: `${config.BOT_NAME}` },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
              ...
              sections: [
                {
                  ...
                  highlight_label: `${config.BOT_NAME}`,
                  rows: [
...
//===============================
    ...
    try {
        ...
        let thumbnailUrl = config.RCD_IMAGE_PATH;
...
╰━━━━━━━━━━━━━━━━━≽`
        ...
        await socket.sendMessage(sender, {
            text: `⚠️ ${config.BOT_NAME} : erreur lors de la récupération des news, réessaie !`
        });
    }
    break;
}
                    ...
                    try {
                        ...
                        if (data && data.length > 0) {
                            ...
                            await socket.sendMessage(sender, {
                                video: { url: videoUrl },
                                mimetype: 'video/mp4',
                                caption: `⤷ 𝚙𝚘𝚠𝚎𝚛𝚎𝚍 ✧ ${config.BOT_FOOTER}`
                            }, { quoted: fakevCard });
...
case 'ai': {
    ...
    const prompt = `ʏᴏᴜʀ name is ${config.BOT_NAME}
...
If asked "Who are you?": Reply "I'm ${config.BOT_NAME}… 👾".  
If asked "Who created you?": Reply "I was created by ${config.OWNER_NAME}".  
...
//===============================
                  ...
                  await socket.sendMessage(sender, { react: { text: '🔮', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: imageBuffer,
                            caption: `🧠 *${config.BOT_NAME} ᴀɪ ɪᴍᴀɢᴇ*\n\n📌 ᴘʀᴏᴍᴘᴛ: ${prompt}`
                        }, { quoted: fakevCard });
                    } catch (err) {
...
// case 38: shorturl
  ...
  try {
    ...
    await socket.sendMessage(sender, {
      ...
      forwardedNewsletterMessageInfo: {
        newsletterJid: config.NEWSLETTER_JID,
        newsletterName: config.BOT_FOOTER,
        serverMessageId: -1
      }
    });
